...
@section('title-meta')
	...
	<title>Biology-AdmissionTestHub-A complete solution for your admission preparation</title>
...
@section('content')
	...
	<!-- page-banner-section
			...
			<div class="section-content banner-text1-section">
				<div class="container">
					<h1>
						<a href="#">Zoology- Lectures and Exercises</a>
						<a href="#">Botany - Lectures and Exsercises</a>
					</h1>					
				</div>
			</div>
			...
			<div class="section-content banner-text1-section">
				<div class="container">
					<div class="section-link">
						<h1>
							<a href="#">Zoology- Lectures and Exerces</a>
							<a href="#">Botany - Lectures and Exsercises</a>
						</h1>
					</div>					
				</div>
