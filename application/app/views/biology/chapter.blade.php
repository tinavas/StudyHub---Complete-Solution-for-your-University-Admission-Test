...
@section('title-meta')
	...
	<title>Chapter-AdmissionTestHub-A complete solution for your admission preparation</title>
...
@section('content')
	...
	<!-- page-banner-section
			...
			<div class="section-content banner-text1-section">
				<div class="container">
					<h1>
						<a href="">When you ready, try these exercises</a>
					</h1>					
				</div>
			</div>
